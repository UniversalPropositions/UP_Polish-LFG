...
- `git clone https://github.com/UniversalPropositions/UP_Polish-LFG.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Polish-LFG>/ --input_up=<up_path_to_UP_Polish-LFG>/ --output=<path_to_UD+UP_Polish-LFG>/`
